package com.ruoyi.union.pdd.module;
...
public class PddModule {
     ...
     */
    public <T extends PopBaseHttpResponse> T execute(Map<String, String> params) {
        // 记录请求参数，方便后续调试和监控
        if (pddConfig.isDebug()) log.info("请求参数：{}", params);
        // 从参数中获取 API 方法名
        String apiMethodName = params.get("apiMethodName");
        // 检查 API 方法名是否为空，如果为空则抛出 ServiceException 异常
        ...
        // 检查该 API 方法是否已集成，如果未集成则抛出 ServiceException 异常
