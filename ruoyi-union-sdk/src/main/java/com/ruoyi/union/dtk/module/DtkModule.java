package com.ruoyi.union.dtk.module;
...
import com.ruoyi.union.dtk.constants.DtkApiConstants;
...
public class DtkModule {
     ...
     */
    public <T extends DtkApiResponse> T execute(Map<String, String> params) {
        // 记录请求参数，方便调试和监控
